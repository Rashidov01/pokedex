...
for (var movie of pokemons) {
	var elMovie = elPokemonsItemTemplate.cloneNode(true);

	elMovie.querySelector('.pokemon__img').src = movie.img;
	elMovie.querySelector('.pokemon__title').textContent = movie.name;
	elMovie.querySelector('.pokemon__info').textContent = movie.num;

	elPokemonsListFragment.appendChild(elMovie);
}

elMoviesList.appendChild(elPokemonsListFragment);